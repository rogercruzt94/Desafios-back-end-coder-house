...
Por ejemplo, el día 20 de Febrero del 2023 corrí los tests, se generó **`TestResults_2023-02-20.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2023-02-20.txt
